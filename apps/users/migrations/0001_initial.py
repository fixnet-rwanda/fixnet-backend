    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('customer', 'Customer'), ('technician', 'Technician'), ('support_agent', 'Support Agent'), ('finance_admin', 'Finance Admin'), ('system_admin', 'System Admin')], default='customer', max_length=20)),
