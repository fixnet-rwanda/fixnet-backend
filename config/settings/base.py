...
SECRET_KEY = os.getenv("SECRET_KEY", "fixnet-backend-dev-secret-key-1234567890")
...
# SimpleJWT Configuration (REQ-AUTH-03)
SIMPLE_JWT = {
    ...
    "USER_ID_FIELD": "id",
    "USER_ID_CLAIM": "sub",
    "TOKEN_ISSUER": os.getenv("JWT_ISSUER", "fixnet-auth-service"),
}
...
# FixNet Business Logic Constants
